![2025-04-26_225058](./assets/2025-04-26_225058.jpg)
...
/ {
	...
	maple_keys {
	    ...
	    mkey-gpios = <&gpiog 3 GPIO_ACTIVE_LOW>,  /* KEY0:PG3 */
					 <&gpioh 7 GPIO_ACTIVE_LOW>; /* KEY1:PH7 */

		/* led added to coexist with key-interrupt by Mapleay*/
		mled-gpio = <&gpioi 0 GPIO_ACTIVE_LOW>;  /* 刻意不加s */
...
这俩按键，和一个LED灯的pins，都绑定在一个 device 上，自定义的面向对象驱动。